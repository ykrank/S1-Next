...
class GeneralPreferencesImpl(context: Context, sharedPreferences: SharedPreferences) : BasePreferences(context, sharedPreferences), GeneralPreferences {
    ...
    override val isDeviceInfoShownInSignature: Boolean by PreferenceDelegates.bool(
            R.string.pref_key_device_info, R.bool.pref_device_info_default_value)
...
interface GeneralPreferences {
    ...
    val isDeviceInfoShownInSignature: Boolean
