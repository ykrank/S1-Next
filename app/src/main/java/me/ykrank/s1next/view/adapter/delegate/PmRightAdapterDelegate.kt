...
class PmRightAdapterDelegate(context: Context) : BaseAdapterDelegate<Pm, PmRightAdapterDelegate.BindingViewHolder>(context, Pm::class.java) {
    ...
    class BindingViewHolder(val binding: ItemPmRightBinding) : RecyclerView.ViewHolder(binding.root)
}
