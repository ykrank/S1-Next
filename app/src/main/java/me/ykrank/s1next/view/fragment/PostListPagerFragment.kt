 ...
 */
class PostListPagerFragment : BaseRecyclerViewFragment<AppPostsWrapper>(), OnQuickSideBarTouchListener {
    ...
    companion object {
        ...
        private fun filterPostAfterBlacklistChanged(dataSet: List<Any>): List<Any> {
            ...
            dataSet.filterIsInstance<AppPost>()
                    .mapNotNullTo(newData) { AppPostsWrapper.filterPost(it) }
            return newData
        }
    }
}
