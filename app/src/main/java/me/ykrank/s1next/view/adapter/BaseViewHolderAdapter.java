 ...
 */
public abstract class BaseViewHolderAdapter<D, VH extends BaseViewHolderAdapter.BaseViewHolder> extends ArrayAdapter<D> {
    ...
    public BaseViewHolderAdapter(Context context, @LayoutRes int resource, List<D> objects) {
